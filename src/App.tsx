...
function LoginPage({ onLogin, users }: { onLogin: (name: string, password: string) => boolean; users: User[] }) {
...
function GenerationPage({ data, setData, user }: { data: { triplets: Triplet[]; users: User[] }; setData: React.Dispatch<React.SetStateAction<{ triplets: Triplet[]; users: User[] }>>; user: User }) {
...
function AnnotationPage({ data, setData, user }: { data: { triplets: Triplet[]; users: User[] }; setData: React.Dispatch<React.SetStateAction<{ triplets: Triplet[]; users: User[] }>>; user: User }) {
  ...
  let currentTriplet: Triplet | null = null
  ...
  const handleAnnotate = (label: string) => {
